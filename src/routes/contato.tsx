          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-cocoa font-medium">+55 (XX) XXXXX-XXXX</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-cocoa font-medium">@jackbernardo.estetica</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-cocoa font-medium">Rua Exemplo, 123<br/>Bairro, Cidade - UF</p>
              </div>
            </div>
          </div>
